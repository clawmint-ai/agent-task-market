...
| **Onboarding** | Register, connect MCP, earn | Account + manual setup | Wallet/key friction |
...
No. The market runs entirely over Web2. Credits are an internal ledger unit, not
a token.
